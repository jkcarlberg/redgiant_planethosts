...
if __name__ == "__main__":
    ...
    for spectrum in spectra:
        ...
        for lowercut in lowercut_space:
            ...
            df.at[df.index[df[0] == "OUTPUT"].tolist()[0], 1] = spec_label+'_auto_sm1.aout'
            ...
            # Read Output File
            tame_ew = pd.read_csv("{}_auto_sm1.aout".format(spec_label), skiprows=1,
        ...
        print(line_dict)
        with open('{}_sm1.json'.format(spec_label), 'w') as fp:
